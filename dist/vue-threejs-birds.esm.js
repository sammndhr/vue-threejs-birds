import { Scene, Camera, Mesh, PlaneBufferGeometry, ShaderMaterial, WebGLRenderTarget, RGBAFormat, HalfFloatType, FloatType, DataTexture, NearestFilter, ClampToEdgeWrapping, PerspectiveCamera, Fog, WebGLRenderer, Color, BufferGeometry, BufferAttribute, Vector3, RepeatWrapping, DoubleSide } from 'three';
...
var script = {
  ...
  methods: {
    ...
    getNewColor: function getNewColor(order) {
      var colorMode = this.colorMode[this.colorEffect],
